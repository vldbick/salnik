...
function App() {
  return (
    <div className="App">
      <main>
        <Myself img="/image/logoava.JPG" title='Трошки про мене' desc='Привіт, мене звуть Назарчук Олександра і я студентка 5 курсу Львівського національного медичного університету. Я створила для вас курс з домедичної допомоги, бо з власного досвіду знаю, на скільки важливим є питання надання домедичної допомоги, і впевнена, що знаючи прості алгоритми будь-хто може ефективно надати першу допомогу.' but={true}></Myself>
